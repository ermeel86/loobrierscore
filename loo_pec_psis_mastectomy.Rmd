...
survs1 <- surv_const(times_pec, 
                     X, 
                     summary(fit)$summary["intercept", "mean"], 
                     summary(fit)$summary[sprintf("betas[%d]", 1:ncol(X)), "mean"]
)
```
...
survs2 <- surv_mspline(i_spline_basis_evals,
                       X,
                      summary(fit2)$summary[sprintf("gammas[%d]", 1:nbasis), "mean"],                
                      summary(fit2)$summary["intercept", "mean"], 
                      summary(fit2)$summary[sprintf("betas[%d]", 1:ncol(X)), "mean"]                       
                       )
```
